...
async function runAutomationAll({ contextFactory, selected = null, options = {}, onStart = null, onComplete = null, onProgress = null } = {}) {
  ...
  }, { onStart, onComplete, concurrency: 1, action: 'run-all' });
  return {
    task: 'run-all',
    accounts,
    preflight,
