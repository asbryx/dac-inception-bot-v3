...
async function runReceiveAll({ contextFactory, selected = null, count = 1, amount = '0.0001', onStart = null, onComplete = null, concurrency = 1 } = {}) {
  ...
  }, { onStart, onComplete, concurrency, action: 'receive-all' });
  return {
    task: 'receive-all',
    accounts,
    preflight,
